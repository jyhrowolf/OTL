...
{
	bb = instance_create_layer(x+(_x + (165)*(i >= 2))*3,y-(_y - (79)*(i == 1 || i == 2))*3,"GUI",o_alert_build_blueprint_display);
	bb.image_xscale = 3;
	bb.image_yscale = 3;
...
_x = -274;
_y = 79;
bb = instance_create_layer(x+(_x)*3,y-(_y)*3,"GUI",o_alert_build_blueprint_display);
bb.image_xscale = 3;
bb.image_yscale = 3;
