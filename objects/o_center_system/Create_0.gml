...
var ship = instance_create_layer(x,y,"Player",o_center);
ships[0] = ship;
ship.update_color();
neutrals = 2;
...
for(var i = 0; i < 3; i++)
{
	...
	var planet = instance_create_layer(x+global.hex_size*.45*cos(pi/3*index),y+global.hex_size*.45*sin(pi/3*index),"Planets",o_planet);
